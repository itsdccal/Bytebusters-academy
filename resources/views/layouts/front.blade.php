...
<head>
    ...
    <title>Bytebusters Academy</title>
</head>
...
<body>
    <header class="header" id="header">
        <div class="nav container">
            <a href="{{ route('home') }}" class="nav-logo">
                <img src="{{ asset('frontend/assets/images/Bytebusters-logo.png') }}" alt="Bytebusters-logo" width="40"
                    height="34" class="d-inline-block align-text-top"> Bytebusters Academy
            </a>
    ...
    <footer class="footer section">
        ...
        <span class="footer-copy">&#169; Andi Muh Haikal. All rights</span>
    </footer>
